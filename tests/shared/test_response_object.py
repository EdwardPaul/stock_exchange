...
def test_response_failure_from_invalid_request_object():
    response = res.ResponseFailure.build_from_invalid_request_objects(req.InvalidRequestObject())
...
def test_response_failure_from_invalid_request_object_with_errors():
    ...
    response = res.ResponseFailure.build_from_invalid_request_objects(request_object)
...
def test_response_failure_build_resourse_error():
    response = res.ResponseFailure.build_resourse_error("test message")
